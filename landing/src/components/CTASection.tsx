    ...
    >
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-primary/20 rounded-full blur-3xl opacity-50" />

          <div className="relative z-10 px-8 py-16 sm:px-16 sm:py-24 text-center">
            <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground max-w-3xl mx-auto">
